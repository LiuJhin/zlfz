...
const menuItems = computed(() => [
  ...
  },
  {
    ...
    dropdownItems: [
      {
        title: "区块链交易所解决方案",
        link: "/industry-solutions/blockchain-exchange",
        icon: "solution",
        description: "专业的区块链交易所技术解决方案，支持现货、衍生品交易",
      },
      {
        title: "量化交易解决方案",
        link: "/industry-solutions/quantitative-trading",
        icon: "solution",
      ...
      {
        title: "直播点播解决方案",
        link: "/industry-solutions/live-streaming",
        icon: "solution",
        description: "专业级音视频服务平台，支持超低延迟直播和点播",
      },
    ],
  },
  {
