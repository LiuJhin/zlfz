    ...
    <div class="about-qualifications-container">
      ...
      <ScrollAnimations type="stagger" stagger="0.15" threshold="0.1">
        <div class="qualifications-grid">
          <div v-for="(qualification, index) in qualifications" :key="index" class="qualification-card">
            <div class="qualification-icon svg-animate" :style="{ backgroundColor: qualification.bgColor }">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path class="svg-path" d="M12 15C15.866 15 19 11.866 19 8C19 4.13401 15.866 1 12 1C8.13401 1 5 4.13401 5 8C5 11.866 8.13401 15 12 15Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path class="svg-path" d="M8.21 13.89L7 23L12 20L17 23L15.79 13.88" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </div>
            <div class="qualification-content">
              ...
              <div class="qualification-details">
                <div class="qualification-detail">
                  ...
                  <span class="detail-value">{{ qualification.certNumber }}</span>
                </div>
                <div class="qualification-detail">
                  <span class="detail-label">发证日期:</span>
                  <span class="detail-value">{{ qualification.issueDate }}</span>
                </div>
                <div class="qualification-detail">
                  <span class="detail-label">有效期至:</span>
                  <span class="detail-value">{{ qualification.validUntil }}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <ScrollAnimations type="stagger" stagger="0.1" threshold="0.1">
            <div class="certifications-grid">
              <div v-for="(certification, index) in certifications" :key="index" class="certification-item">
                <div class="certification-logo shimmer" :style="{ backgroundColor: certification.bgColor }">
...
const qualifications = reactive([
  {
    title: '高新技术企业认证',
    description: '国家认定的高新技术企业，拥有核心自主知识产权',
  ...
  {
    title: 'ISO 27001信息安全管理体系认证',
    description: '国际标准化组织信息安全管理体系认证',
...
const certifications = reactive([
  {
    name: '区块链服务网络认证',
    abbr: 'BSN',
    description: '区块链服务网络官方认证服务提供商',
    bgColor: '#3B82F6'
  },
  {
    name: '可信区块链推进计划成员',
    abbr: 'TCBP',
    description: '中国信息通信研究院可信区块链推进计划成员单位',
    bgColor: '#10B981'
  },
  {
    name: '网络安全等级保护',
    abbr: 'MLPS',
    description: '通过国家网络安全等级保护三级认证',
    bgColor: '#F59E0B'
  },
  {
    name: '云计算服务安全评估',
    abbr: 'CCSS',
    description: '通过国家云计算服务安全评估',
    bgColor: '#EC4899'
  }
]);
