  ...
  <section class="about-contact">
    <div class="about-contact-container">
          ...
          <div class="info-item">
            ...
            <div class="info-content">
              ...
              <div class="social-links">
                <a href="https://weixin.qq.com/" class="social-link" title="微信公众号" target="_blank">
                ...
                <a href="https://weibo.com/" class="social-link" title="微博" target="_blank">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://www.zhihu.com/" class="social-link" title="知乎" target="_blank">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="contact-form-section">
        ...
        <p class="form-description">如果您有任何问题或建议，请随时与我们联系。我们将尽快回复您。</p>
        ...
        <form class="contact-form" @submit="handleSubmit">
          ...
          <div class="form-group">
            ...
            <input type="text" id="subject" placeholder="请输入消息主题" required />
          </div>
          
          <div class="form-group">
            <label for="message">消息</label>
            <textarea id="message" rows="5" placeholder="请输入您的消息内容" required></textarea>
          </div>
...
.map-placeholder {
  ...
  position: relative;
  box-shadow: var(--card-shadow);
  background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100"><rect width="100" height="100" fill="%23f0f0f0"/><path d="M0,0L100,100M0,100L100,0" stroke="%23e0e0e0" stroke-width="1"/></svg>');
...
.form-group textarea:focus {
  ...
  box-shadow: 0 0 0 3px rgba(130, 71, 229, 0.2);
}
