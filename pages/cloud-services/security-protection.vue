      ...
      <div class="container">
        ...
        <div class="features-grid">
          ...
          <div class="feature-card">
            <div class="feature-icon">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                <path d="M6 10C6 7.79086 7.79086 6 10 6H14C16.2091 6 18 7.79086 18 10V11H19C20.1046 11 21 11.8954 21 13V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V13C3 11.8954 3.89543 11 5 11H6V10Z" stroke="currentColor" stroke-width="2"/>
...
definePageMeta({
  layout: 'default',
  title: '云安全防护服务 - ZHILING ARK TECHNOLOGY',
  description: '全方位的云安全解决方案，威胁检测、数据保护、合规管理'
})
...
useHead({
  title: '云安全防护服务 - ZHILING ARK TECHNOLOGY',
  meta: [
    { name: 'description', content: '提供企业级云安全防护服务，包括威胁检测、数据保护、合规管理等，构建多层次安全防护体系' },
    { name: 'keywords', content: '云安全,威胁检测,数据保护,合规管理,安全监控,身份管理' }
  ]
})
</script>
...
@keyframes shield-glow {
  ...
  50% { box-shadow: 0 20px 60px rgba(var(--primary-color-rgb), 0.3); }
}
