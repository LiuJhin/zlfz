      ...
      <div class="container">
        ...
        <div class="features-grid">
          ...
          <div class="feature-card">
            <div class="feature-icon">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M8 12H16M8 9H12M8 15H14" stroke="currentColor" stroke-width="2"/>
              </svg>
            </div>
            <h3>备份恢复</h3>
          ...
          <div class="feature-card">
            <div class="feature-icon">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                <path d="M16 4H18C19.1046 4 20 4.89543 20 6V18C20 19.1046 19.1046 20 18 20H6C4.89543 20 4 19.1046 4 18V6C4 4.89543 4.89543 4 6 4H8M16 4C16 2.89543 15.1046 2 14 2H10C8.89543 2 8 2.89543 8 4M16 4C16 5.10457 15.1046 6 14 6H10C8.89543 6 8 5.10457 8 4" stroke="currentColor" stroke-width="2"/>
          ...
          <div class="dashboard-feature">
            <div class="feature-icon">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                ...
                <circle cx="12" cy="1" r="3" stroke="currentColor" stroke-width="2"/>
                <circle cx="6" cy="11" r="3" stroke="currentColor" stroke-width="2"/>
              </svg>
            </div>
            <h3>智能告警</h3>
...
definePageMeta({
  layout: 'default',
  title: '云运维管理服务 - ZHILING ARK TECHNOLOGY',
  description: '7x24小时专业云运维保障，智能监控、自动化运维和专业团队支持'
})
...
useHead({
  title: '云运维管理服务 - ZHILING ARK TECHNOLOGY',
  meta: [
    { name: 'description', content: '提供全天候的云基础设施运维管理服务，通过智能监控、自动化运维和专业团队支持，确保系统稳定运行' },
    { name: 'keywords', content: '云运维,监控服务,自动化运维,性能优化,安全管理,备份恢复' }
  ]
})
</script>
...
.service-tier.featured .tier-header {
  background: var(--primary-color);
  color: white;
}
