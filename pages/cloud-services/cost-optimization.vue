          ...
          <div class="feature-card">
            <div class="feature-icon">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M7 8L17 8M7 12L17 12M7 16L13 16" stroke="currentColor" stroke-width="2"/>
              </svg>
            </div>
            <h3>成本分析报告</h3>
...
definePageMeta({
  layout: 'default',
  title: '云成本优化服务 - ZHILING ARK TECHNOLOGY',
  description: '智能化云成本管理与优化，帮助企业降低云支出，提升资源利用率'
})
...
useHead({
  title: '云成本优化服务 - ZHILING ARK TECHNOLOGY',
  meta: [
    { name: 'description', content: '通过专业的成本分析和优化策略，帮助企业降低云支出，提升资源利用率，实现云投资回报最大化' },
    { name: 'keywords', content: '云成本优化,资源优化,成本管理,预算控制,云支出分析' }
  ]
})
</script>
